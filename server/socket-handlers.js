...
// ── Sub-module imports ──
const combatHandlers = require('./socket-handlers-combat');
const eventHandlers = require('./socket-handlers-events');
...
// ── Combat handlers (delegated to socket-handlers-combat.js) ──
exports.handleAttack = combatHandlers.handleAttack;
exports.handleSkill = combatHandlers.handleSkill;
exports.handleUsePotion = combatHandlers.handleUsePotion;

// ── Loot handlers (delegated to socket-handlers-combat.js) ──
exports.handleLootPickup = combatHandlers.handleLootPickup;
exports.handleLootPickupNearest = combatHandlers.handleLootPickupNearest;
...
// ── Chest handler (delegated to socket-handlers-combat.js) ──
exports.handleChestOpen = combatHandlers.handleChestOpen;
...
// ── Gem handlers (delegated to socket-handlers-events.js) ──
exports.handleGemSocket = eventHandlers.handleGemSocket;
exports.handleGemUnsocket = eventHandlers.handleGemUnsocket;
exports.handleGemCombine = eventHandlers.handleGemCombine;

// ── Loot filter (delegated to socket-handlers-combat.js) ──
exports.handleLootFilter = combatHandlers.handleLootFilter;

// ── Enchanting handlers (delegated to socket-handlers-events.js) ──
exports.handleEnchantPreview = eventHandlers.handleEnchantPreview;
exports.handleEnchantExecute = eventHandlers.handleEnchantExecute;

// ── Gambling handler (delegated to socket-handlers-events.js) ──
exports.handleGamble = eventHandlers.handleGamble;
